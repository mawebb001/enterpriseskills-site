      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white">
            Not just prompts. A system.
          </h2>
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-400">
            Skills are structured, governed, and verifiable. Every execution follows a deterministic pipeline.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group rounded-2xl border border-gray-200 p-8 transition-all hover:border-brand-300 hover:shadow-lg hover:shadow-brand-100/50 dark:border-gray-800 dark:hover:border-brand-700 dark:hover:shadow-brand-950/50"
            >
              <div className="mb-4 inline-flex rounded-xl bg-brand-50 p-3 text-brand-600 dark:bg-brand-950 dark:text-brand-400">
                {feature.icon}
              </div>
